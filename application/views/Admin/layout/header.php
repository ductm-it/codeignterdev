                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="index.html" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="assets/admin/images/logo-sm.png" alt="logo-sm" height="22">
                                </span>
                                <span class="logo-lg">
                                    <img src="assets/admin/images/logo-dark.png" alt="logo-dark" height="20">
                                </span>
                            </a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div>
                                                    <img src="assets/admin/images/megamenu-img.png" alt="megamenu-img" class="img-fluid mx-auto d-block">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
