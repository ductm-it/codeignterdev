    ...
    function t(e) {
        1 == n("#light-mode-switch").prop("checked") && "light-mode-switch" === e ?
            ...
            (n("html").removeAttr("dir"),
                ...
                n("#bootstrap-style").attr(
                    "href",
                    "public/assets/admin/css/bootstrap-dark.min.css"
                ),
                n("#app-style").attr(
                    "href",
                    "public/assets/admin/css/app-dark.min.css"
                ),
            ...
            (n("#light-mode-switch").prop("checked", !1),
                ...
                n("#bootstrap-style").attr(
                    "href",
                    "public/assets/admin/css/bootstrap-rtl.min.css"
                ),
                n("#app-style").attr(
                    "href",
                    "public/assets/admin/css/app-rtl.min.css"
                ),
                n("html").attr("dir", "rtl"),
    ...
    n("#side-menu").metisMenu(),
        ...
        n(document).ready(function() {
            ...
            0 < n("#sidebar-menu").length &&
                ...
                ((e -= 300),
                    n(".vertical-menu .simplebar-content-wrapper").animate({ scrollTop: e },
                        "slow"
                    ));
        }),
